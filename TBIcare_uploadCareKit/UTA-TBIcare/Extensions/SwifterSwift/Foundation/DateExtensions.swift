...
public extension Date {
    ...
    func islamicUmmAlQura(withFormat format: String = "dd/MM/yyyy HH:mm", locale: String? = nil) -> String {
    ...
    /// - Returns: date string.
    func string(withFormat format: String = "dd/MM/yyyy HH:mm", locale: String? = nil) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = format
        if locale != nil {
            dateFormatter.locale = Locale(identifier: locale!)
    ...
    func dayName(ofStyle style: DayNameStyle = .full, locale: String = "en") -> String {
